...
class CameraCalibrator:
    ...
    def find_corners(self, image: np.ndarray) -> bool:
        ...
        if ret:
            ...
            cv2.drawChessboardCorners(image, self.pattern_size, corners_refined, ret)
    ...
    def calibrate(self, image_size: Tuple[int, int]) -> Dict:
        ...
        print(f"재투영 오차: {self.calibration_error:.3f} 픽셀")
        print(f"카메라 매트릭스: {mtx}")
        print(f"카메라 왜곡계수: {dist}")
